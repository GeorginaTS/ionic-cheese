...
import { IonInput, IonIcon, IonItem, IonContent, IonButton } from "@ionic/angular/standalone";
...
@Component({
  ...
  standalone: true,
  imports: [IonButton, IonContent, IonItem, IonIcon, IonInput, FormsModule, CommonModule]
})
